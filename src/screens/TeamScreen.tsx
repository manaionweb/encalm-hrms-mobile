            ...
            {isAdmin && (
                <View style={tw`px-4 pt-4`}>
                    <TouchableOpacity
                        ...
                        style={tw`flex-row items-center justify-center gap-2 p-4 bg-indigo-50 dark:bg-slate-800 border border-dashed border-indigo-300 dark:border-slate-700 rounded-3xl`}
                    >
                        <Plus size={18} color="#4f46e5" />
                        <Text style={tw`text-indigo-650 dark:text-indigo-400 font-bold text-xs`}>Create New Team</Text>
                    </TouchableOpacity>
                </View>
            )}
            ...
            {loading ? (
                ...
                <ScrollView style={tw`flex-grow p-4`} contentContainerStyle={tw`pb-12`}>
                    {teams.map((team) => (
                        <View 
                            key={team.id}
                            style={tw`bg-white dark:bg-slate-800 p-5 rounded-3xl mb-4 border border-gray-100 dark:border-slate-700 shadow-sm`}
                        >
                            ...
                            <View style={tw`flex-row justify-between items-center mt-4 pt-3 border-t border-gray-50 dark:border-slate-700`}>
                                ...
                                <Text style={tw`text-xs text-indigo-600 dark:text-indigo-400 font-bold`}>
