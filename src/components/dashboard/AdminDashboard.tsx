...
export default function AdminDashboard({
    ...
    return (
        <ScrollView style={tw`flex-1 px-4 py-4`} contentContainerStyle={tw`pb-12`}>
            ...
            {/* Approval Center */}
            <View style={tw`bg-white dark:bg-[#181537] p-5 rounded-3xl border border-gray-100 dark:border-white/10 shadow-sm mb-6`}>
            ...
            <View style={tw`mb-6`}>
                ...
                <View style={tw`bg-white dark:bg-[#181537] rounded-3xl border border-gray-100 dark:border-white/10 shadow-sm p-4`}>
                    {employees
