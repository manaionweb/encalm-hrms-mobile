...
export default function HeadcountStats({ headcount, onLeaveToday, newJoiners, avgAttendance, navigation }: HeadcountStatsProps) {
    const stats = [
        { label: 'TOTAL EMPLOYEES', value: headcount, icon: Users, color: "#8b5cf6", bg: 'bg-[#f5f3ff]', path: 'EmployeeStack', screen: 'EmployeeList' },
        { label: 'On Leave Today', value: onLeaveToday, icon: UserMinus, color: '#f97316', bg: 'bg-orange-50', path: 'LeaveToday', screen: '' },
        { label: 'New Joiners', value: newJoiners, icon: UserCheck, color: '#22c55e', bg: 'bg-green-50', path: 'NewJoiners', screen: '' },
            ...
            {stats.map((stat, index) => (
                ...
                >
                    <View style={tw`flex-row justify-between items-start`}>
                        ...
                        <View style={[tw`p-2.5 rounded-2xl ${stat.bg} dark:bg-white/5`]}>
